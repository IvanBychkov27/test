...
// https://postgrespro.ru/docs/postgresql/9.6/ddl-basics
...
func createTable(db *sql.DB) {
	...
	var schema = `CREATE TABLE collector (
    id                  integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	created_at          integer DEFAULT round(EXTRACT(EPOCH FROM NOW())), --преобразование даты в timestamp типа int
	widget_id           integer NOT NULL,
	endpoint_id         integer NOT NULL,
	user_id             integer NOT NULL,
	push_endpoint       text NOT NULL,
	push_key_auth       text NOT NULL,
	push_key_p256dh     text NOT NULL,
	language            varchar(255) NOT NULL DEFAULT '',
	timezone_browser    integer DEFAULT 0,
	source_id           text NOT NULL DEFAULT '',
	ip                  varchar(127) NOT NULL,
	country             varchar(127) NOT NULL,
	timezone_ip         integer DEFAULT 0,
	ua                  text NOT NULL,
	...
	fmt.Println("Создана таблица collector")
}
