...
func (p *PusherW) Send(message []byte, s *Subscription, options *Options) (*http.Response, error) {
	...
	if sharedX == nil {
		return nil, fmt.Errorf("unmarshal error: public key is not a valid point on the curve")
	}
